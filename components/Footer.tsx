      ...
      <div className="mx-auto max-w-[1100px] px-6 py-12">
        ...
        <div className="mt-8 flex flex-col gap-2 text-[13px] text-[color:var(--ink-3)] md:flex-row md:items-center md:justify-between">
          <p className="flex items-center gap-1.5">
            Designed <span aria-hidden>+</span> coded with
            {/* 하트는 문자가 아니라 SVG 다. 이모지로 두면 폰트에 따라
                컬러 이모지로 떨어져 회색 캡션 줄에서 혼자 튄다. */}
            <svg aria-hidden width="12" height="12" viewBox="0 0 12 12" fill="none"
              className="shrink-0 translate-y-[0.5px]">
              <path d="M6 10.2S1.4 7.5 1.4 4.5a2.6 2.6 0 0 1 4.6-1.6A2.6 2.6 0 0 1 10.6 4.5c0 3-4.6 5.7-4.6 5.7Z"
